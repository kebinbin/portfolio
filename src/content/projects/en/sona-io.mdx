...
img_alt: Sona web application's feed showing the current artists playing around San Juan soon.
description: |
  Discover new music artists and events happening near you or around the world by experiencing music first instead of focusing on traditional flyers or event listings.  Explore artists profiles, see where are they going to be performing in the future and discover other artists that will be performing on the same events.
tags:
  - Design
  - Development
  - Product Design
...
<TextBlock title="Behind this project">This web app was designed to make local music more accessible — helping users discover nearby events and instantly connect with the artists through their music. It also gives independent artists a space to reach local audiences and promote their shows, bridging the gap between digital streaming and live performance.</TextBlock>
<Video src="/assets/projects/case-study-2/video-2.mp4" title="Learn more about artists you are interested by hearing more music, and seeing with whom are they going to perform soon and where." />
